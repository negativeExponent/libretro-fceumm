...
#define BMCFLAG_512KCHRR  0x0020
...
static BMAPPING bmap[] = {
	...
	{ "820310-C",                   321, 0, Mapper321_Init, 0 },
	...
	{ "K-3032",                     340, 0, Mapper340_Init, 0 },
	{ "TJ-03",                      341, 0, Mapper341_Init, 0 },
	{ "COOLGIRL",                   342, 0, Mapper342_Init,  BMCFLAG_512KCHRR },
	...
	{ "TL-8042",                    453, 0, Mapper453_Init, 0 },
...
int UNIFLoad(const char *name, FCEUFILE *fp) {
	...
	ROM.prg.size = prg_size_bytes;
	ROM.chr.size = chr_size_bytes;
	...
	if (CHRRAMSIZE) {
		FCEU_printf(" [UNIF] CHR RAM: %d KiB\n", CHRRAMSIZE / 1024);
	}
